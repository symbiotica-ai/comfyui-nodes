...
class NSWaveSpeedInfiniteTalkMulti:
    """
...
NODE_CLASS_MAPPINGS = {
    "NSWaveSpeedInfiniteTalkMulti": NSWaveSpeedInfiniteTalkMulti
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "NSWaveSpeedInfiniteTalkMulti": "NS WaveSpeed InfiniteTalk Multi"
}