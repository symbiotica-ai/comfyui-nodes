...
ENHANCER_SYSTEM_PROMPT = (
    ...
    "4. Content only — no style or rendering language (no 'vector art', "
    "'cell-shaded', 'outlines', 'illustration', render technique, or "
    "quality words). The pipeline states the art style ONCE globally; each "
    "region prompt describes only what is in the region.\n"
