...
class NSWaveSpeedNanoBananaProEdit:
    """
...
NODE_CLASS_MAPPINGS = {
    "NSWaveSpeedNanoBananaProEdit": NSWaveSpeedNanoBananaProEdit
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "NSWaveSpeedNanoBananaProEdit": "NS WaveSpeed Nano Banana Pro Edit"
}
