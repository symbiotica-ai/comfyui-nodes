...
class NSWaveSpeedWan25TextToVideo:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
# Node registration
NODE_CLASS_MAPPINGS = {
    "NSWaveSpeedWan25TextToVideo": NSWaveSpeedWan25TextToVideo
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "NSWaveSpeedWan25TextToVideo": "NS WaveSpeed Wan 2.5 Text to Video"
}