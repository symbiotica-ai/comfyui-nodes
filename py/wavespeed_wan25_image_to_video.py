...
class NSWaveSpeedWan25ImageToVideo:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
# Node registration
NODE_CLASS_MAPPINGS = {
    "NSWaveSpeedWan25ImageToVideo": NSWaveSpeedWan25ImageToVideo
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "NSWaveSpeedWan25ImageToVideo": "NS WaveSpeed Wan 2.5 Image to Video"
}