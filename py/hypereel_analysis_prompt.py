...
DEFAULT_TASK = (
    ...
    "screen AND what makes a viewer stop scrolling - the audacity, skill, luck, or "
    "absurdity of it> | BEATS: <the 2-4 events inside the window, in order, position words only "
