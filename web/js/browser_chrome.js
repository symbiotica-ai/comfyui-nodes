...
export const ICON = {
    ...
    layers: "M8 2.2L2.4 5.2 8 8.2l5.6-3z M2.4 8.8L8 11.8l5.6-3"
            + " M2.4 11.6L8 14.6l5.6-3",
    link: "M6.7 8.7a3.3 3.3 0 0 0 5 .4l2-2a3.3 3.3 0 0 0-4.7-4.7L7.8 3.5"
          + " M9.3 7.3a3.3 3.3 0 0 0-5-.4l-2 2a3.3 3.3 0 0 0 4.7 4.7l1.1-1.1",
    ticked: "M3.2 3.2h9.6v9.6H3.2z M5.5 8.1l1.8 1.8 3.3-3.7",
    unticked: "M3.2 3.2h9.6v9.6H3.2z",
};
